        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Desc_EstadoCita = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_EstadoCitas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEstadoCitaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_Citas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_t_Citas_T_EstadoCitas_IdEstadoCitaId",
                        column: x => x.IdEstadoCitaId,
                        principalTable: "T_EstadoCitas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_Citas_IdEstadoCitaId",
                table: "t_Citas",
                column: "IdEstadoCitaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_EstadoCitas_Desc_EstadoCita",
                table: "T_EstadoCitas",
                column: "Desc_EstadoCita",
                unique: true);
